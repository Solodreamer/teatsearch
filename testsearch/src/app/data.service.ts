...
export class DataService {
  ...
  constructor(private http: HttpClient) {}
    ...
    public getStockSorts(): Observable<Array<any>> { // getStockSorts ()為取得使用者責任中心清單
    const url = 'http://test.his.cmuh.org.tw/WebApi/MatStockManager/MatStock/GetOptionInfos/MatStockMt/invType ';
    return this.http.get<Array<any>>(url);
    }
